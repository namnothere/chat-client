...
const Tagging = (
	...
	const toggleActive = (index: number) => {
		changeState({ ...appState, activeObject: messages[index] });

	}
	const toggleActiveStyle = (index: number) => {
		if (messages[index] === appState.activeObject)
			return "visible";
		else return "hidden";
	}
	return (
											...
											return (
												<div className="tag-container"  >
													<TextField id="standard-basic"
														onMouseOver={() => toggleActive(index)}
														onMouseOut={handleShowOff}
																...
																<>
																	<InputAdornment position="end">
																		<EditIcon color="primary" onClick={() => {
																			...
																			sx={{
																				cursor: 'pointer',
																				visibility: `${toggleActiveStyle(index)}`
																			}}
																		>
																		</EditIcon>
																	</InputAdornment>
